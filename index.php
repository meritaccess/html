...
// pole pohledu
$stat_view_array = ['l' => 'lock', 'h' => 'home', 'a' => 'access', 'c' => 'cards', 'u' => 'users', 'o' => 'config', 'r' => 'running', 'm' => 'more', 'x' => 'drop', 'v' => 'logs'];
$stat_cond_array = ['e' => 'edit', 'p' => 'past', 'd' => 'delete', 'b' => 'block'];
$stat_info_array = ['o' => 'order'];
$stat_fact_array = ['z' => 'alert'];
// titulky v title
$title_view_array = ['lock' => 'Login', 'home' => 'Dashboard', 'access' => 'Access', 'config' => 'Configuration', 'cards' => 'Cards', 'running' => 'Running', 'users' => 'Users', 'more' => 'More', 'logs' => 'Logs'];
// pole vyloucenych, ktere musi mit login
$keys_url_array_except = [$stat_view_array['h'], $stat_view_array['a'], $stat_view_array['o'], $stat_view_array['c'], $stat_view_array['r'], $stat_view_array['u'], $stat_view_array['d'], $stat_view_array['m'], $stat_view_array['v']];
...
?>
		...
		<ul id="more">
			...
			<li id="version"><a href="./?v=home">Version <?php
...
?>" required="required">
				<label for="fornovactecka">Reader <span class="required">*</span></label><input type="text" id="fornovactecka" name="nova-ctecka" value="1" placeholder="1 &ndash; default" required="required">
				<label for="fornovycasplan">Timezone <span class="required">*</span></label><input type="text" id="fornovycasplan" name="novy-cas-plan" value="0" placeholder="0 &ndash; default" required="required">
				<label for="fornovepovoleni">Access <span class="required">*</span></label><input type="text" id="fornovepovoleni" name="nove-povoleni" value="1" placeholder="1 &ndash; default" required="required">
